...
Computational & Data Sciences student at George Mason University Microdoft Certified: Power BI Data Analyst Associate (PL-300)
...
### 🚜 Coral Island Crop Analysis (Power BI) — *Incoming Project Soon!*
This project tackles a classic resource allocation problem in the farming sim *Coral Island*. By building a custom dataset from v1.1 telemetry, I developed a report to optimize gold, land, and stamina usage.
**Tools:** Power BI, DAX, Data Modeling, Manual Data Curation
* **Key Metrics:** ROI %, Profit Per Season (Cash Velocity), and dynamic Break-Even Points for capital assets (Fruit Trees).
* **Early Insight:** While high-value "Cash Crops" look good on paper, high-frequency regrowing crops often provide the liquidity needed for early-game growth.
